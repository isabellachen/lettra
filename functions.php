...
if (!function_exists('lettra_setup')) :
  /**
   ...
   */
  function lettra_setup()
  {
    /*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Lettra, use a find and replace
		 * to change 'lettra' to the name of your theme in all the template files.
		 */
    load_theme_textdomain('lettra', get_template_directory() . '/languages');
    ...
    register_nav_menus(array(
      'menu-1' => esc_html__('Primary', 'lettra'),
      'menu-2' => esc_html__('Secondary', 'lettra')
    ));
    ...
    add_theme_support('custom-background', apply_filters('lettra_custom_background_args', array(
...
add_action('after_setup_theme', 'lettra_setup');
 ...
 */
function lettra_content_width()
{
  // This variable is intended to be overruled from themes.
  // Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
  // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
  $GLOBALS['content_width'] = apply_filters('lettra_content_width', 640);
}
add_action('after_setup_theme', 'lettra_content_width', 0);
 ...
 */
function lettra_widgets_init()
{
  register_sidebar(array(
    'name'          => esc_html__('Sidebar', 'lettra'),
    'id'            => 'sidebar-1',
